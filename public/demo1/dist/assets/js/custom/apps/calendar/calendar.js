...
var KTAppCalendar = function () {
    ...
    const q = e => {
        C();
        const n = x.allDay ? moment(x.fecha).format("Do MMM, YYYY") : moment(x.fecha).format("Do MMM, YYYY - h:mm a"),
            a = x.allDay ? moment(x.fechafin).format("Do MMM, YYYY") : moment(x.fechafin).format("Do MMM, YYYY - h:mm a");
        var o = {
            container: "body",
            trigger: "manual",
            boundary: "window",
            ...
            html: !0,
            title: "Event Summary",
            content: '<div class="fw-bolder mb-2">' + x.idpaciente + '</div><div class="fs-7"><span class="fw-bold">Start:</span> ' + n + '</div><div class="fs-7 mb-4"><span class="fw-bold">End:</span> ' + a +
        ...
        A = () => {
            var e, t, n;
            w.show(),
                x.allDay ? (e = "All Day", t = moment(x.fecha).format("Do MMM, YYYY"), n = moment(x.fechafin).format("Do MMM, YYYY")) : (e = "", t = moment(x.fecha).format("Do MMM, YYYY - h:mm a"),
                    n = moment(x.fechafin).format("Do MMM, YYYY - h:mm a")),
                g.innerText = x.idpaciente,
                S.innerText = e,
                Y.innerText = x.idespecialista ? x.idespecialista : "--",

                T.innerText = t, M.innerText = n
        },
        H = () => {
                ...
                t.preventDefault(),
                    ...
                    (() => {
                        f.innerText = "Edit an Event",
                            v.show();
                        const t = p.querySelectorAll('[data-kt-calendar="datepicker"]'),
                            r = p.querySelector("#kt_calendar_datepicker_allday"); r.addEventListener("click", (e => {
                                e.target.checked ? t.forEach((e => { e.classList.add("d-none") })) : (d.setDate(x.fecha, !0, "Y-m-d"),
                                    t.forEach((e => {
                                        e.classList.remove("d-none")
                                    }
                                    )))
                                ...
                                _.addEventListener("click", (function (t) {
                                    t.preventDefault(), y && y.validate().then((function (t) {
                                        console.log("validated!"),
                                            "Valid" == t ? (_.setAttribute("data-kt-indicator", "on"),
                                                _.disabled = !0, setTimeout((function () {
                                                    _.removeAttribute("data-kt-indicator"),
                                                        Swal.fire({
                                                            text: "New event added to calendar!",
                                                            icon: "success",
        ...
        O = () => {
            n.value = x.idpaciente ? x.idpaciente : "",
                a.value = x.idespecialista ? x.idespecialista : "",

                i.setDate(x.fecha, !0, "Y-m-d");
            const e = x.fecha ? x.fechafin : moment(x.fecha).format();
            d.setDate(e, !0, "Y-m-d");
            ...
            ))) : (c.setDate(x.fecha, !0, "Y-m-d H:i"),
                u.setDate(x.fechafin, !0, "Y-m-d H:i"),
                d.setDate(x.fecha, !0, "Y-m-d"),
                t.checked = !1,
                r.forEach((e => {
                    e.classList.remove("d-none")
        ...
        P = e => {
            x.id = e.id,
                x.idpaciente = e.title,
                x.idespecialista = e.description,
    ...
    return {
        init: function () {
            ...
            p = t.querySelector("#kt_modal_add_event_form"),
                n = p.querySelector('[name="idpaciente"]'),
                a = p.querySelector('[name="idespecialista"]'),
            ...
            var F, O, I, R, G, K; w = new bootstrap.Modal(B),
                ...
                (e = new FullCalendar.Calendar(F, {
                    ...
                    eventClick: function (e) {
                        C(),
                            P({
                                id: e.event.id,
                                idpaciente: e.event.idpaciente,
                                idespecialista:  e.event.idespecialista,
                                fecha: e.event.fecha,
                                fechafin: e.event.fechafin,
                ...
                k.addEventListener("click", (function (e) {
                    e.preventDefault(),
                        ...
                        }).then((function (e) { e.value ? (p.reset(), v.hide()) : "cancel" === e.dismiss && Swal.fire({ 
                            text: "Your form has not been cancelled!.",
